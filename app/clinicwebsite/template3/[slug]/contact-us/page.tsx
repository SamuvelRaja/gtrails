        ...
        <div className="max-w-7xl mx-auto px-8 w-full">
          <div className="text-center mb-20 space-y-5">
            ...
            <div className="flex flex-col items-center">
              ...
              <h4 className="text-5xl md:text-6xl font-normal text-emerald-900 leading-none tracking-tighter -mt-[4px]">When You Arrive</h4>
            </div>
            ...
            <div className="flex-1 space-y-8">
              <div className="space-y-4">
                ...
                <div className="flex flex-col">
                  ...
                  <h4 className="text-4xl md:text-5xl lg:text-6xl font-normal text-emerald-900 leading-none tracking-tighter -mt-[4px]">Find Us</h4>
                </div>
              </div>
