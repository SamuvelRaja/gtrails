          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="flex flex-col items-center justify-center text-center px-4">
              ...
              <div className="flex flex-col items-center mb-6">
                ...
                <h1 className="text-6xl md:text-7xl lg:text-8xl font-normal text-emerald-900 leading-none tracking-tighter -mt-[12px]">
                  {line2}
                </h1>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link 
                  ...
                  className="px-8 py-4 rounded-full bg-white border border-gray-200 text-emerald-900 font-medium hover:bg-gray-100 transition-colors text-sm tracking-wide"
                >
                  Meet the Experts
                </Link>
                <a 
                  href={`tel:${clinic.contact?.phone || ''}`}
                  className="px-8 py-4 rounded-full text-white bg-emerald-900 hover:bg-emerald-950 font-medium transition-colors text-sm tracking-wide"
                >
                  Schedule Your Visit
                </a>
              </div>
