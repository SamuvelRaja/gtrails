            ...
            <div className="flex-1 space-y-8">
              <div className="space-y-4">
                ...
                <div className="flex flex-col">
                  ...
                  <h4 className="text-4xl md:text-5xl lg:text-6xl font-normal text-emerald-900 leading-none tracking-tighter -mt-1">{clinic.name || 'Our Clinic'}</h4>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-8 w-full">
          <div className="mb-20 space-y-5 text-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <h4 className="text-5xl md:text-6xl lg:text-7xl font-normal text-emerald-900 leading-none tracking-tighter -mt-1.5">That Drive Us</h4>
            </div>
          ...
          <div className="relative space-y-0">
            ...
            {[
              ...
              <div key={i} className={`relative flex flex-col md:flex-row items-start gap-8 md:gap-16 pb-16 last:pb-0 ${i % 2 === 0 ? '' : 'md:flex-row-reverse'}`}>
                {/* Dot */}
                <div className="absolute left-6 md:left-1/2 w-4 h-4 bg-white rounded-full border-4 border-emerald-900 -translate-x-1/2 mt-2 z-10" />
            ...
            <div className="flex-1 order-1 lg:order-2 lg:pt-10 space-y-10">
              <div className="space-y-4">
                ...
                <div className="flex flex-col">
                  ...
                  <h4 className="text-5xl md:text-6xl lg:text-7xl font-normal text-emerald-900 leading-none tracking-tighter -mt-1.5">Specialist</h4>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-8 w-full">
          <div className="text-center mb-20 space-y-5">
            ...
            <div className="flex flex-col items-center">
              ...
              <h4 className="text-5xl md:text-6xl font-normal text-emerald-900 leading-none tracking-tighter -mt-1">For Every Need</h4>
            </div>
