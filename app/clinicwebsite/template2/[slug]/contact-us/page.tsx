...
export default async function ContactUsPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const basePath = `/clinicwebsite/template2/${slug}`;
        ...
        <div className="max-w-7xl mx-auto px-8 w-full">
          <div className="grid lg:grid-cols-5 gap-12 lg:gap-20">
            ...
            <div className="lg:col-span-2 space-y-12">
              <div>
                <h3 className="text-3xl font-normal text-blue-900 mb-4 tracking-tight">Get In Touch</h3>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-5 p-6 bg-gray-50 rounded-3xl border border-gray-100">
                  ...
                  <div>
                    <h4 className="font-medium text-blue-900 mb-2">Clinic Address</h4>
                    ...
                    <a href={`https://maps.google.com/?q=${encodeURIComponent(clinic.address?.full || '')}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-blue-900 font-medium text-xs uppercase tracking-widest mt-4 hover:text-gray-500 transition-colors">
                ...
                <div className="flex items-start gap-5 p-6 bg-gray-50 rounded-3xl border border-gray-100">
                  ...
                  <div>
                    <h4 className="font-medium text-blue-900 mb-2">Phone Directory</h4>
                    <p className="text-gray-600 font-light text-sm">Appointments & General Enquiries:</p>
                    <a href={`tel:${clinic.contact?.phone || ''}`} className="text-blue-900 font-medium text-lg hover:text-gray-600 transition-colors block mt-1">
                ...
                <div className="flex items-start gap-5 p-6 bg-gray-50 rounded-3xl border border-gray-100">
                  ...
                  <div>
                    <h4 className="font-medium text-blue-900 mb-2">Email Us</h4>
                    <p className="text-gray-600 font-light text-sm">For non-urgent queries or insurance inquiries:</p>
                    <a href={`mailto:contact@${slug.replace(/-/g, '')}.com`} className="text-blue-900 font-medium mt-1 block hover:text-gray-600 transition-colors">
                ...
                <div className="flex items-start gap-5 p-6 bg-gray-50 rounded-3xl border border-gray-100">
                  ...
                  <div className="w-full">
                    <h4 className="font-medium text-blue-900 mb-3">Operating Hours</h4>
                    <div className="space-y-3 text-sm font-light text-gray-600 w-full">
                      <div className="flex justify-between border-b border-gray-200 pb-2"><span>Monday – Friday</span><span className="font-medium text-blue-900">10:00 AM – 9:00 PM</span></div>
                      <div className="flex justify-between border-b border-gray-200 pb-2"><span>Saturday</span><span className="font-medium text-blue-900">10:00 AM – 9:00 PM</span></div>
                      <div className="flex justify-between"><span>Sunday</span><span className="font-medium text-blue-900">10:00 AM – 6:00 PM</span></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-3">
              <div className="bg-gray-50 p-8 lg:p-12 rounded-3xl border border-gray-100">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <h3 className="text-2xl font-normal text-blue-900 tracking-tight">Book an Appointment</h3>
                </div>
                ...
                <form className="space-y-6">
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="text" className="w-full px-5 py-4 rounded-2xl border border-gray-200 focus:outline-none focus:border-blue-900 transition-all bg-white placeholder:text-gray-300 text-sm" placeholder="John" />
                    </div>
                    <div>
                      <label className="block text-xs font-semibold tracking-widest text-gray-500 uppercase mb-2">Last Name *</label>
                      <input type="text" className="w-full px-5 py-4 rounded-2xl border border-gray-200 focus:outline-none focus:border-blue-900 transition-all bg-white placeholder:text-gray-300 text-sm" placeholder="Doe" />
                    </div>
                  </div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="tel" className="w-full px-5 py-4 rounded-2xl border border-gray-200 focus:outline-none focus:border-blue-900 transition-all bg-white placeholder:text-gray-300 text-sm" placeholder="+91 98765 43210" />
                    </div>
                    <div>
                      <label className="block text-xs font-semibold tracking-widest text-gray-500 uppercase mb-2">Email Address</label>
                      <input type="email" className="w-full px-5 py-4 rounded-2xl border border-gray-200 focus:outline-none focus:border-blue-900 transition-all bg-white placeholder:text-gray-300 text-sm" placeholder="john@example.com" />
                    </div>
                  </div>

                  <div>
                    <label className="block text-xs font-semibold tracking-widest text-gray-500 uppercase mb-2">I am interested in *</label>
                    <select className="w-full px-5 py-4 rounded-2xl border border-gray-200 focus:outline-none focus:border-blue-900 transition-all bg-white text-gray-700 text-sm appearance-none cursor-pointer">
                  ...
                  <div>
                    ...
                    <input type="text" className="w-full px-5 py-4 rounded-2xl border border-gray-200 focus:outline-none focus:border-blue-900 transition-all bg-white placeholder:text-gray-300 text-sm" placeholder="e.g. Tuesday afternoon, or any weekday morning" />
                  </div>

                  <div>
                    <label className="block text-xs font-semibold tracking-widest text-gray-500 uppercase mb-2">Additional Notes</label>
                    <textarea rows={4} className="w-full px-5 py-4 rounded-2xl border border-gray-200 focus:outline-none focus:border-blue-900 transition-all bg-white placeholder:text-gray-300 text-sm resize-none" placeholder="Tell us about your dental concern..."></textarea>
                  </div>

                  <button type="button" className="w-full py-4 bg-blue-900 hover:bg-blue-950 transition-colors text-white rounded-full font-medium text-sm tracking-wide shadow-md flex items-center justify-center gap-3">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="text-center bg-white p-8 rounded-3xl border border-gray-100 flex flex-col items-center">
                <div className="w-14 h-14 bg-gray-100 rounded-full flex items-center justify-center text-blue-900 font-normal text-xl mb-6">
                  {item.step}
                </div>
                <h5 className="font-medium text-blue-900 text-lg mb-4">{item.title}</h5>
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
            <div className="flex-1 space-y-8">
              ...
              <div className="space-y-6 text-gray-600 text-[16px] leading-relaxed font-light">
                <p>
                  We are conveniently located at <strong className="text-blue-900 font-medium">{clinic.address?.full || 'a centrally accessible location'}</strong>. Our clinic is easily reachable by public transport, auto-rickshaw, or private vehicle.
                </p>
                <p>
              ...
              <div className="space-y-4 pt-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-4">
                    <span className="w-1.5 h-1.5 bg-blue-900 rounded-full shrink-0"></span>
            ...
            <div className="flex-1 w-full">
              <div className="aspect-[4/3] bg-gray-50 rounded-3xl border border-gray-100 flex items-center justify-center flex-col p-8 text-center">
                ...
                <a href={`https://maps.google.com/?q=${encodeURIComponent(clinic.address?.full || '')}`} target="_blank" rel="noopener noreferrer" className="mt-8 px-6 py-3 rounded-full border border-gray-200 text-blue-900 text-xs font-semibold tracking-widest uppercase hover:bg-white transition-colors">
                  Open Maps
                </a>
              </div>
            </div>
