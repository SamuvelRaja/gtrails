...
export default async function ClinicHome({ params }: PageProps) {
  ...
  return (
    <div className="font-sans text-blue-900 bg-gray-50 min-h-screen selection:bg-blue-900 selection:text-white">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
            {[
              ...
              <div key={idx} className="flex flex-col group p-6 rounded-3xl hover:bg-gray-50 transition-colors duration-300">
                ...
                <h5 className="text-xl font-medium text-blue-900 mb-3">{feature.title}</h5>
      ...
      <section className="py-24 lg:py-32 bg-gray-50">
        <div className="max-w-7xl mx-auto px-8 w-full">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-20">
            ...
            <Link href={`${basePath}/services`} className="inline-flex items-center gap-2 pb-1 border-b border-blue-900 text-blue-900 font-medium hover:text-gray-600 hover:border-gray-600 transition-colors uppercase tracking-wider text-sm whitespace-nowrap">
              View All Services
            </Link>
          </div>
            ...
            {servicesList.map((svc: string, i: number) => (
              <div key={i} className="bg-white p-10 rounded-3xl border border-gray-100 hover:border-gray-300 hover:shadow-lg transition-all duration-300 flex flex-col group min-h-80">
                ...
                <Link href={`${basePath}/services`} className="flex items-center justify-between mt-auto border-t border-gray-100 pt-6">
                  <span className="text-sm font-medium uppercase tracking-[0.15em] text-blue-900 group-hover:text-gray-500 transition-colors">Read Details</span>
                  <div className="w-8 h-8 rounded-full bg-gray-50 flex items-center justify-center text-gray-500 group-hover:bg-blue-900 group-hover:text-white transition-all transform group-hover:translate-x-1">
      ...
      {/* GALLERY */}
      <section className="py-24 lg:py-32 bg-blue-900">
        <div className="max-w-7xl mx-auto px-8 w-full">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-20">
            <div className="space-y-5 flex-1">
            ...
            {[
              ...
              <div key={idx} className="group cursor-pointer flex flex-col h-full">
                ...
                <div className="flex justify-between items-center px-2">
                  ...
                  <div className="w-10 h-10 rounded-full border border-gray-600 flex items-center justify-center text-white group-hover:bg-white group-hover:text-blue-900 transition-all">
             ...
             <div className="order-1 lg:order-2 space-y-12">
               ...
               <div className="space-y-8">
                 <div className="flex gap-5 group">
                   <div className="mt-1"><Stethoscope className="w-6 h-6 text-gray-400 group-hover:text-blue-900 transition-colors" /></div>
                   <div>
                     <h5 className="text-lg font-medium text-blue-900">Oral Surgeons & Implantologists</h5>
                 ...
                 <div className="flex gap-5 group">
                   <div className="mt-1"><HeartPulse className="w-6 h-6 text-gray-400 group-hover:text-blue-900 transition-colors" /></div>
                   <div>
                     <h5 className="text-lg font-medium text-blue-900">Endodontists & Periodontists</h5>
                 ...
                 <div className="flex gap-5 group">
                   <div className="mt-1"><Smile className="w-6 h-6 text-gray-400 group-hover:text-blue-900 transition-colors" /></div>
                   <div>
                     <h5 className="text-lg font-medium text-blue-900">Pediatric & Orthodontic Experts</h5>
      ...
      <section className="py-24 lg:py-32 bg-white">
        <div className="max-w-4xl mx-auto px-8 w-full">
          ...
          <div className="space-y-2">
            {faqs.map((faq, idx) => (
               <details key={idx} className="group border-b border-gray-200 open:pb-6">
                 <summary className="flex items-center justify-between py-8 cursor-pointer list-none font-medium text-xl text-blue-900">
          ...
          <div className="mt-16 bg-gray-50 rounded-3xl p-10 text-center border border-gray-100 flex flex-col items-center">
             <h5 className="font-medium text-2xl text-blue-900 mb-3">Have a different question?</h5>
             <p className="text-gray-500 mb-8 max-w-lg mx-auto">Our front-desk team is always available to help you with your queries.</p>
             <a href={`tel:${clinic.contact?.phone || ''}`} className="inline-flex px-8 py-3.5 rounded-full bg-blue-900 text-white hover:bg-[#1a2229] transition-colors font-medium text-sm tracking-wide">
                Call Us Directly
             </a>
          </div>
        </div>
      ...
      <section className="py-24 lg:py-40 bg-blue-900 text-white">
        <div className="max-w-4xl mx-auto px-8 text-center w-full">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
               <a href={`tel:${clinic.contact?.phone || ''}`} className="w-full sm:w-auto px-8 py-4 rounded-full bg-white text-blue-900 font-medium hover:bg-gray-100 transition-colors flex items-center justify-center gap-2 text-sm tracking-wide">
