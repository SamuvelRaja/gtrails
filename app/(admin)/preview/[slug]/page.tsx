...
export default function PreviewPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const templates = [
    ...
    { id: '4', name: 'Precision Engineering', description: 'Performance and technology-focused brutalist design.', href: `/clinicwebsite/template4/${slug}` },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-8">
      <div className="w-full max-w-4xl bg-white p-8 rounded-xl shadow-lg border border-gray-100">
        ...
        <p className="text-gray-500 text-center mb-12">Your data for <strong>{slug}</strong> has been bound to 4 distinct templates. Click below to preview them.</p>
